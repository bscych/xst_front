...
<body>
    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <a class="navbar-brand" href="{{url('home')}}"> <img alt="Charisma Logo" src="/img/logo20.png" class="hidden-xs"/>
...
<div class="ch-container">
    <div class="row">
      ...
      <hr>
    <footer class="row">
        <p class="col-md-9 col-sm-9 col-xs-12 copyright">&copy; <a href="#" target="_blank">Shane</a>2018</p>
